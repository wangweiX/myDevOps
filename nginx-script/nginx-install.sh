...
#------------------------------------------------------
#
# Nginx compile install script on Ubuntu 16.04
#
...
compile(){
	...
	# apt-get install openssl libssl-dev libperl-dev libpcre3 libpcre3-dev zlib1g zlib1g-dbg zlib1g-dev libxslt1-dev  libgd2-xpm-dev
	apt-get install checkinstall build-essential libgeoip-dev uuid-dev libgd-dev libgoogle-perftools-dev libxml2-dev libxslt1-dev
	...
	#
	# Instead of running `make install`, create a .deb and install from there.
	# This allows you to easily uninstall the package if there are issues.
